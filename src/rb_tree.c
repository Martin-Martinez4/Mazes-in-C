...
void leftRotate(RBTree* tree, RBNode* pivotParent) {
  /*
    ...
    Else if current is the left child of parent, make  current node's right
...
/*
  Constraints:
    ...
    - The simple path from any node to a leaf has to touch the same number of
  black nodes along the way.
